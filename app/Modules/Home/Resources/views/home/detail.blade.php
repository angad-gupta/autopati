        ...
        <div class="container">
            ...
            <div class="tab-color-selector">
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade show @if($loop->first) active @endif" id="color-{{$color_val->id}}" role="tabpanel" aria-labelledby="home-tab">
                        <figure>
                ...
                <ul class="nav nav-tabs menu menu-palette" id="myTab" role="tablist">
                    @foreach($car_color as $key => $color_val)
                    <li class="menu-item">
                        <a class="menu-link @if($loop->first) active @endif" id="home-tab" data-toggle="tab" href="#color-{{$color_val->id}}" role="tab" aria-controls="home" aria-selected="true" style="background: {{$color_val->color_code}}">
                        </a>
                    </li>
                    @endforeach
