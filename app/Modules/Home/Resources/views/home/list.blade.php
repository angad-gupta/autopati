    ...
    <section class="ecm-features ecm-new p">
        <div class="container">
           {{-- <div class="row justify-content-center mb-5">
                <div class="col-sm-12">
                    <div class="ecm-features__title d-block d-md-flex align-items-center justify-content-between">
                        <h1>Search For :<span> {{$title}}</span></h1>
                        <h1 class="mt-3 mt-md-0"><span style="color: #e53012">{{count($vehicles)}} </span> Found !</h1>
                    </div>
                </div>
            </div>--}}
            ...
            <div class="section-title">
                <div class="section-title--content">
                    <h2>
                        Search For :<span> {{$title}}</span>
                    </h2>
                </div>

                <div class="section-title--support">
                    <span style="color: #e53012">{{count($vehicles)}} </span> Found !
                </div>
            </div>
