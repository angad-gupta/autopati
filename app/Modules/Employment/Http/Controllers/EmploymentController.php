...
class EmploymentController extends Controller
{
    ...
    public function create()
    {
        ...
        $data['branch'] = $this->dropdown->getFieldBySlug('branch');
        $data['department'] = $this->dropdown->getFieldBySlug('department');
        $data['designation'] = $this->dropdown->getFieldBySlug('designation');
        $data['level'] = $this->dropdown->getFieldBySlug('level');
        $data['unit'] = $this->dropdown->getFieldBySlug('unit');
        $data['rank'] = $this->dropdown->getFieldBySlug('rank');
        ...
        $data['contract_type'] = $this->dropdown->getFieldBySlug('contract_type');
        $data['job_type'] = $this->dropdown->getFieldBySlug('job_type');
