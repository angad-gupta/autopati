                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-9 form-group-feedback form-group-feedback-right">
                                <div class="input-group">
                                    ...
                                    {!! Form::text('spec_title', $value = $spec->spec_title, ['disabled','class'=>'form-control']) !!}

                                    {!! Form::hidden('spec_id',$spec_id) !!}
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-9 form-group-feedback form-group-feedback-right">
                                <div class="input-group">
                                   ...
                                   {!! Form::text('title', $value = null, ['id'=>'title','placeholder'=>'Enter Spec Feature Title','class'=>'form-control','required']) !!}
                                </div>
                            </div>
                        </div>
                    </div>
