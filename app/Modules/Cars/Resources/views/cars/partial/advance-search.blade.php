 ...
 {{-- Start of Advance Filter Shyam --}}
    <div class="card card border-light-600 bg-light">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <div class="input-group">
                    ...
                    @endphp
                    {!! Form::select('brand_id[]', $brand_name, $brand, ['class'=>'form-control multiselect-filtering', 'multiple']) !!}
                </div>
            </div>
            ...
            <div class="col-md-3">
                ...
                <div class="input-group">
                    ...
                    @endphp
                    {!! Form::select('model_id[]', $model_name, $model, ['class'=>'form-control multiselect-filtering', 'multiple']) !!}
                </div>
            </div>
                ...
                <div class="input-group">
                    ...
                    @endphp
                    {!! Form::select('variant_id[]', $variant_name, $variant, ['class'=>'form-control multiselect-filtering', 'multiple']) !!}
                </div>
            </div>
        ...
        <div class="d-flex justify-content-end mt-2">
            ...
            <a href="{{ route('cars.index') }}" data-popup="tooltip" data-placement="top" data-original-title="Refresh Search" class="btn bg-danger ml-2">
