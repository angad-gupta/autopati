...
<ul class="fab-menu fab-menu-absolute fab-menu-top-right" data-fab-toggle="hover" id="fab-menu-affixed-demo-right">
    <li>
     ...
     <a href="{{ route('vehiclemodel.index') }}" class="fab-menu-btn btn bg-danger btn-float rounded-round btn-icon"><i class="icon-arrow-left15" data-popup="tooltip" data-placement="bottom" data-original-title="Back To Model"></i></a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-9 form-group-feedback form-group-feedback-right">
                                <div class="input-group">
                                     {!! Form::select('brand_id',$brand, $value = null, ['id'=>'brand_id','class'=>'brand_id form-control select-search',' data-fouc']) !!}
