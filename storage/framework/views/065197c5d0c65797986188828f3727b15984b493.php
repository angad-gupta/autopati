<?php $__env->startSection('title'); ?>Compare | Autopati <?php $__env->stopSection(); ?>
<?php $__env->startSection('breadcrumb'); ?> Compare <?php $__env->stopSection(); ?>
                                        ...
                                        <div class="compare_dd mt-3">
                                            <div class="col-lg-12 form-group-feedback form-group-feedback-right mb-3">
                                                <div class="input-group">
                                                    <?php echo Form::select('first_brand_id',$brand, $value = null, ['placeholder'=>'-- Select Brand --','id'=>'first_brand_id','class'=>'brand_id form-control select-search',' data-fouc']); ?>
                                            ...
                                            <div class="col-lg-12 form-group-feedback form-group-feedback-right mb-3">
                                                <div class="input-group">
                                                    <?php echo Form::select('first_model_id', [''=>'-- Select Model --'],null,['id'=>'first_model_id','class'=>'form-control select-search']); ?>

                                                </div>
                                            </div>
                                            <div class="col-lg-12 form-group-feedback form-group-feedback-right">
                                                <div class="input-group">
                                                    <?php echo Form::select('first_variant_id', [''=>'-- Select Variant --'],null,['id'=>'first_variant_id','class'=>'form-control select-search']); ?>
                                ...
                                <div class="col-md-3">
                                    <div class="compare_item">
                                        ...
                                        <div class="compare_dd mt-3">
                                            <div class="col-lg-12 form-group-feedback form-group-feedback-right mb-3">
                                                <div class="input-group">
                                                    <?php echo Form::select('second_brand_id',$brand, $value = null, ['placeholder'=>'-- Select Brand --','id'=>'second_brand_id','class'=>'brand_id form-control select-search',' data-fouc']); ?>
                                            ...
                                            <div class="col-lg-12 form-group-feedback form-group-feedback-right mb-3">
                                                <div class="input-group">
                                                    <?php echo Form::select('second_model_id', [''=>'-- Select Model --'],null,['id'=>'second_model_id','class'=>'form-control select-search']); ?>

                                                </div>
                                            </div>
                                            <div class="col-lg-12 form-group-feedback form-group-feedback-right">
                                                <div class="input-group">
                                                    <?php echo Form::select('second_variant_id', [''=>'-- Select Variant --'],null,['id'=>'second_variant_id','class'=>'form-control select-search']); ?>
...
<?php echo $__env->make('home::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/angadgupta/Desktop/Bidhee/Autopati/autopati/app/Modules/Home/Resources/views/home/compare.blade.php ENDPATH**/ ?>