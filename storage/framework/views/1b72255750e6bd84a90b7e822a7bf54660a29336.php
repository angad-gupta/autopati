...
<section class="ecm-banner">
    <div class="owl-carousel owl-theme banner-slider">
        <?php $banner = app('\App\Modules\Banner\Repositories\BannerRepository'); ?>
        <?php
        ...
        <div class="item">
            <div class="banner-block" style="background-image: url('<?php echo e(($header_banner->banner_image) ? asset($header_banner->file_full_path).'/'.$header_banner->banner_image : asset('admin/default.png' )); ?>');">
                <div class="container">
...
<section class="ecm-features ecm-new pb-0">
    <div class="container">
        ...
        <div class="owl-carousel owl-theme new-arrival">
            <?php $dealofmonth = app('\App\Modules\Cars\Repositories\CarRepository'); ?>
            <?php
            ...
            <div class="item">
                <a href="category.php" class="ecm-new__item">
                    <img src="<?php echo e(($deal_of_the_month->car_image) ? asset($deal_of_the_month->file_full_path).'/'.$deal_of_the_month->car_image : asset('admin/default.png' )); ?>" alt="<?php echo e($deal_of_the_month->ModelInfo->model_name); ?> <?php echo e($deal_of_the_month->VariantInfo->variant_name); ?>">
                    <h5><?php echo e($deal_of_the_month->BrandInfo->brand_name); ?></h5>
                </a>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<section class="ecm-features ecm-new pb-0">
    <div class="container">
        ...
        <div class="owl-carousel owl-theme brand discount-slider mt-4">
            <?php $get_car_brand = app('\App\Modules\Brand\Repositories\BrandRepository'); ?>
            <?php
            ...
            <div class="item">
                <a href="category.php" class="brand-item">
                    <img src="<?php echo e(($car_brand->brand_logo) ? asset($car_brand->file_full_path).'/'.$car_brand->brand_logo : asset('admin/default.png')); ?>" alt="<?php echo e($car_brand->brand_name); ?>">
...
<section class="ecm-features ecm-new pt-3 pb-0">
    <div class="container">
        ...
        <div class="owl-carousel owl-theme brand discount-slider mt-4">
            <?php $get_bike_brand = app('\App\Modules\Brand\Repositories\BrandRepository'); ?>
            <?php
            ...
            <?php $__currentLoopData = $bike_brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bike_brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="item">
                    <a href="category.php" class="brand-item">
                        <img src="<?php echo e(($bike_brand->brand_logo) ? asset($bike_brand->file_full_path).'/'.$bike_brand->brand_logo : asset('admin/default.png')); ?>" alt="<?php echo e($bike_brand->brand_name); ?>">
...
<section class="ecm-features">
    ...
    <div class="owl-carousel owl-theme luxury-block stock-clearance">
        ...
        <?php $__currentLoopData = $luxury_banners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $luxury_banners): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="item">
                <div class="luxury-slider" style="background-image: url('<?php echo e(($luxury_banners->banner_image) ? asset($luxury_banners->file_full_path).'/'.$luxury_banners->banner_image : asset('admin/default.png' )); ?>">
                    <div class="position-relative">
                        <h4>Checkout Luxury car</h4>
                        <p><?php echo e($luxury_banners->short_content); ?></p>
                        <a href="<?php echo e($luxury_banners->banner_link); ?>" class="btn btn-light">
                            View All
                        </a>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="row">
            <?php $luxury = app('\App\Modules\Cars\Repositories\CarRepository'); ?>
            <?php
                $luxuaries = $luxury->findLuxury();
            ?>
            <?php $__currentLoopData = $luxuaries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $luxury): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-md-3">
                <a href="category.php" class="ecm-luxury__item">
                    <span class="ecm-luxury__img">
                        <img src="<?php echo e(($luxury->car_image) ? asset($luxury->file_full_path).'/'.$luxury->car_image : asset('admin/default.png' )); ?>" alt="<?php echo e($luxury->ModelInfo->model_name); ?> <?php echo e($luxury->VariantInfo->variant_name); ?>">
                    </span>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/angadgupta/Desktop/Bidhee/Autopati/autopati/resources/views/index.blade.php ENDPATH**/ ?>