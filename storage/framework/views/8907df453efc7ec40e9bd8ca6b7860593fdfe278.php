            ...
            <div class="row">
                ...
                <div class="col-lg-9 form-group-feedback form-group-feedback-right">
                    <div class="input-group">
                        ...
                        <?php echo Form::text('spec_title', $value = null, ['id'=>'spec_title','placeholder'=>'Enter Spec Title','class'=>'form-control']); ?>
            ...
            <div class="row">
                ...
                <div class="col-lg-9 form-group-feedback form-group-feedback-right">
                    <div class="input-group">
                       ...
                       <?php echo Form::select('automobile',[ 'Car'=>'Car','Bike'=>'Bike','Both'=>'Both'], $value = null, ['id'=>'automobile','class'=>'form-control']); ?>
...
</div><?php /**PATH /Users/angadgupta/Desktop/Bidhee/Autopati/autopati/app/Modules/Spec/Resources/views/spec/partial/action.blade.php ENDPATH**/ ?>