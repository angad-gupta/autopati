                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9 form-group-feedback form-group-feedback-right">
                            <div class="input-group">
                                ...
                                <?php echo Form::text('brand_name', $value = null, ['id'=>'brand_name','placeholder'=>'Enter Brand Name','class'=>'form-control']); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9 form-group-feedback form-group-feedback-right">
                            <div class="input-group">
                               ...
                               <?php echo Form::select('type',[ 'Car'=>'Car','Bike'=>'Bike'], $value = null, ['id'=>'type','class'=>'form-control']); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9 form-group-feedback form-group-feedback-right">
                            <div class="input-group">
                                ...
                                <?php echo Form::file('brand_logo', ['id'=>'brand_logo','class'=>'form-control']); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9 form-group-feedback form-group-feedback-right">
                            <?php if($is_edit): ?>
                                ...
                                <img id="brand_logo" src="<?php echo e($image); ?>" alt="your image" class="preview-image" style="height: 100px;width: auto;" />
                                <?php else: ?>
                                <img id="brand_logo" src="<?php echo e(asset('admin/image.png')); ?>" alt="your image" class="preview-image" style="height: 100px; width: auto;" />
                                <?php endif; ?>
                        </div>
...
<?php /**PATH /Users/angadgupta/Desktop/Bidhee/Autopati/autopati/app/Modules/Brand/Resources/views/brand/partial/action.blade.php ENDPATH**/ ?>