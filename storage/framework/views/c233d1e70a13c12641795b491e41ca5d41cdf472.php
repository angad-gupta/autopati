            ...
            <div class="form-group row">
                <div class="col-lg-6">
                    ...
                    <div class="col-lg-9 form-group-feedback form-group-feedback-right">
                        ...
                        <?php echo Form::select('category_id',$category, $value = null, ['placeholder'=>'-- Select Service Category --','id'=>'servicecategory_id','class'=>'brand_id form-control select-search',' data-fouc']); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9 form-group-feedback form-group-feedback-right">
                            <div class="input-group">
                                ...
                                <?php echo Form::text('title', $value = null, ['id'=>'title','placeholder'=>'Enter Service Title','class'=>'form-control']); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9 form-group-feedback form-group-feedback-right">
                            <div class="input-group">
                                ...
                                <?php echo Form::text('location', $value = null, ['id'=>'location','placeholder'=>'Enter Location','class'=>'form-control']); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9 form-group-feedback form-group-feedback-right">
                            <div class="input-group">
                                ...
                                <?php echo Form::file('cover_image', ['id'=>'cover_image','class'=>'form-control']); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9 form-group-feedback form-group-feedback-right">
                            <?php if($is_edit): ?>
                                ...
                                <?php else: ?>
                                <img id="banner_image" src="<?php echo e(asset('admin/image.png')); ?>" alt="your image" class="preview-image" style="height: 100px; width: auto;" />
                                <?php endif; ?>
                                <br>
                                <br>
                ...
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <div class="col-lg-11 form-group-feedback form-group-feedback-right">
                            <div class="input-group">
                                <?php echo Form::textarea('description', null, ['id' => 'description','placeholder'=>'Enter Description Content', 'class' =>'form-control simple_textarea_description']); ?>
...
<?php /**PATH /Users/angadgupta/Desktop/Bidhee/Autopati/autopati/app/Modules/ServiceManagement/Resources/views/servicemanagement/partial/action.blade.php ENDPATH**/ ?>