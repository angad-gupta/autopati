...
<fieldset class="mb-3">
            ...
            <div class="row">
             ...
             <div class="col-lg-9 form-group-feedback form-group-feedback-right">
                <div class="input-group">
                   <?php echo Form::select('brand_id',$brand, $value = null, ['placeholder'=>'-- Select Brand --','id'=>'brand_id','class'=>'brand_id form-control select-search',' data-fouc']); ?>
            ...
            <div class="row">
               ...
               <div class="col-lg-9 form-group-feedback form-group-feedback-right">
                <div class="input-group">
                     ...
                     <?php if($is_edit): ?>
                        <?php echo Form::select('model_id',$model, $value = $car_info->model_id, ['id'=>'model_id','placeholder'=>'Select Model','class'=>'form-control select-search']); ?>

                     <?php else: ?>
                        <?php echo Form::select('model_id', [''=>'-- Select Model --'],null,['id'=>'model_id','class'=>'form-control select-search']); ?>
            ...
            <div class="row">
               ...
               <div class="col-lg-9 form-group-feedback form-group-feedback-right">
                <div class="input-group">
                     ...
                     <?php if($is_edit): ?>
                       <?php echo Form::select('variant_id',$variant, $value = $car_info->variant_id, ['id'=>'variant_id','placeholder'=>'Select Variant','class'=>' form-control select-search']); ?>

                     <?php else: ?>
                        <?php echo Form::select('variant_id', [''=>'-- Select Variant --'],null,['id'=>'variant_id','class'=>'form-control select-search']); ?>
        ...
        <div class="row">
            ...
            <div class="col-lg-9 form-group-feedback form-group-feedback-right">
                <?php if($is_edit): ?>
                    ...
                    <img id="car_image" src="<?php echo e($image); ?>" alt="your image" class="preview-image" style="height: 100px;width: auto;" />
                    <?php else: ?>
                    <img id="car_image" src="<?php echo e(asset('admin/image.png')); ?>" alt="your image" class="preview-image" style="height: 100px; width: auto;" />
                    <?php endif; ?>
            </div>
            ...
            <div class="row">
             ...
             <div class="col-lg-9 form-group-feedback form-group-feedback-right">
                <div class="input-group">
                    ...
                    <?php echo Form::text('short_quote', $value = null, ['id'=>'short_quote','placeholder'=>'Enter Short Quote','class'=>'form-control']); ?>
        ...
        <div class="col-lg-12">
            <div class="row">
                ...
                <div class="col-lg-10 form-group-feedback form-group-feedback-right">
                    <div class="input-group">
                        <?php echo Form::textarea('description', null, ['id' => 'description','placeholder'=>'Enter Description', 'class' =>'form-control textarea_description']); ?>
            ...
            <div class="row">
             ...
             <div class="col-lg-9 form-group-feedback form-group-feedback-right">
                <div class="input-group">
                    ...
                    <?php echo Form::text('year_of_manufacture', $value = null, ['id'=>'year_of_manufacture','placeholder'=>'Enter Year of Manufacture','class'=>'numeric form-control']); ?>
            ...
            <div class="row">
             ...
             <div class="col-lg-9 form-group-feedback form-group-feedback-right">
                <div class="input-group">
                    ...
                    <?php echo Form::text('starting_price', $value = null, ['id'=>'starting_price','placeholder'=>'Enter Starting Price','class'=>'numeric form-control']); ?>
    ...
    <div class="form-group row">
             ...
             <div class="col-lg-9 form-group-feedback form-group-feedback-right">
                <div class="input-group">
                    <span class="input-group-prepend">
                     ...
                     <?php echo Form::select('is_launch',[ '1'=>'Yes','2'=>'No'], $value = null, ['placeholder'=>'--Select Any --','id'=>'is_launch','class'=>'form-control']); ?>
        ...
        <div class="col-lg-4 currently_launch" <?php echo e($clauch); ?>>
            <div class="row">
             ...
             <div class="col-lg-9 form-group-feedback form-group-feedback-right">
                <div class="input-group">
                    ...
                    <?php echo Form::select('currently_launch',[ '1'=>'Yes','2'=>'No'], $value = null, ['placeholder'=>'--Select Any --','id'=>'currently_launch','class'=>'form-control']); ?>
            ...
            <div class="row">
             ...
             <div class="col-lg-9 form-group-feedback form-group-feedback-right">
                <div class="input-group">
                    ...
                    <?php echo Form::text('expected_launch_date', $value = null, ['id'=>'expected_launch_date','class'=>'daterange-single form-control']); ?>
...
?>
    ...
    <div class="form-group row">
             ...
             <div class="col-lg-9 form-group-feedback form-group-feedback-right">
                <div class="input-group">
                    <span class="input-group-prepend">
                     ...
                     <?php echo Form::select('is_offer_available',[ '1'=>'Yes','2'=>'No'], $value = null, ['placeholder'=>'--Select Any --','id'=>'is_offer_available','class'=>'form-control']); ?>
        ...
        <div class="col-lg-4 offer_discount" <?php echo e($discount); ?>>
            <div class="row">
             ...
             <div class="col-lg-9 form-group-feedback form-group-feedback-right">
                <div class="input-group">
                    ...
                    <?php echo Form::text('discount_percent', $value = null, ['id'=>'discount_percent','placeholder'=>'Enter Starting Price','class'=>'numeric form-control']); ?>
            ...
            <div class="row">
             ...
             <div class="col-lg-9 form-group-feedback form-group-feedback-right">
                <div class="input-group">
                    ...
                    <?php echo Form::text('flat_amount', $value = null, ['id'=>'flat_amount','placeholder'=>'Enter Flat Amount','class'=>'numeric form-control']); ?>
            ...
            <div class="row">
             ...
             <div class="col-lg-9 form-group-feedback form-group-feedback-right">
                <div class="input-group">
                    ...
                    <?php echo Form::select('is_luxury',[ '1'=>'Yes','2'=>'No'], $value = null, ['id'=>'is_luxury','class'=>'form-control']); ?>
            ...
            <div class="row">
             ...
             <div class="col-lg-9 form-group-feedback form-group-feedback-right">
                <div class="input-group">
                    ...
                    <?php echo Form::select('is_deal_of_the_month',[ '1'=>'Yes','2'=>'No'], $value = null, ['id'=>'is_deal_of_the_month','class'=>'form-control']); ?>
            ...
            <div class="row">
             ...
             <div class="col-lg-9 form-group-feedback form-group-feedback-right">
                <div class="input-group">
                    ...
                    <?php echo Form::select('is_popular',[ '1'=>'Yes','2'=>'No'], $value = null, ['id'=>'is_popular','class'=>'form-control']); ?>
            ...
            <div class="row">
             ...
             <div class="col-lg-9 form-group-feedback form-group-feedback-right">
                <div class="input-group">
                    ...
                    <?php echo Form::select('is_electric',[ '1'=>'Yes','2'=>'No'], $value = null, ['id'=>'is_electric','class'=>'form-control']); ?>
            ...
            <div class="row">
             ...
             <div class="col-lg-9 form-group-feedback form-group-feedback-right">
                <div class="input-group">
                    ...
                    <?php echo Form::select('is_top_car',[ '1'=>'Yes','2'=>'No'], $value = null, ['id'=>'is_top_car','class'=>'form-control']); ?>
...
</script><?php /**PATH /Users/angadgupta/Desktop/Bidhee/Autopati/autopati/app/Modules/Cars/Resources/views/cars/partial/action.blade.php ENDPATH**/ ?>